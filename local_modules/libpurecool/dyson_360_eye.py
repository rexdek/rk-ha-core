...
from .const import Dyson360EyeCommand, Dyson360EyeMode, PowerMode
from .dyson_device import DEFAULT_PORT, DysonDevice, NetworkDevice
...
class Dyson360Eye(DysonDevice):
    ...
    def status_topic(self):
        """MQTT status topic."""
        return f"{self.product_type}/{self.serial}/status"
